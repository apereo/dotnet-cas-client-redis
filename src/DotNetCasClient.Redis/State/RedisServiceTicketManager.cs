...
{
    ///<summary>
    /// An IServiceTicketManager implementation that relies on Redis for service ticket
    ...
    public sealed class RedisServiceTicketManager : IServiceTicketManager
    {
        ...
        /// Default constructor.
        /// </summary>
        public RedisServiceTicketManager()
        {
        }

        /// <summary>
        /// Performs initialization of the RedisServiceTicketManager
        /// </summary>
        ...
        {
            // No-op.  The Redis removes expired entries automatically.
        }
        ...
        public CasAuthenticationTicket GetTicket(string serviceTicket)
        {
            ...
            return (CasAuthenticationTicket)SerializationUtil.Deserialize(db.StringGet(key));
        }
        ...
        public void UpdateTicketExpiration(CasAuthenticationTicket casAuthenticationTicket, DateTime newExpiration)
        {
            ...
            // FYI this method performs the Redis 'StringSet' command which basically performs an upsert.
